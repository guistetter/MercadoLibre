...
class Anuncio extends Component {
  constructor(props) {
    ...
    const url = `https://mercadodev-d05fb.firebaseio.com/anuncios/${id}.json`;
  ...
  render() {
    ...
    return (
      <div>
        <h1>{anuncio.nome}</h1>
        <p>
          <img src={anuncio.foto} alt="anuncio" />
          Fazer o resto vagabundo fdp que quer tudo pronto fio da disgraca
          jumento do demonho
        </p>
